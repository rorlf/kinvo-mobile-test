...
import { Text, FlatList, View, TouchableOpacity, Animated } from "react-native";
...
export default function Presentational(props) {
  ...
  renderCardName = () => <Text style={styles.cardName}>{title}</Text>;
  ...
  renderPlusButton = () => <Text style={styles.plusButton}>+</Text>;
  ...
  renderTitleAndIconAndPlusButtonCard = () => {
    ...
    return (
      <View style={styles.titleAndIconAndPlusButtonArea}>
        {titleAndIcon}
        {plusButton}
      </View>
    );
  ...
  renderRegisterScreen = () => {
    ...
    return (
      <View style={styles.registerScreen} ref={ref}>
        <View>
          {title}
          {card}
